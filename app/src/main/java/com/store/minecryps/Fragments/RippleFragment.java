...
public class RippleFragment extends Fragment {
    ...
    String uurl="https://min-api.cryptocompare.com/data/top/exchanges/full?fsym=XRP&tsym=USD";
    ...
    private void initRippleData() {
        ...
        Call<CoinStatModel> call = retrofitApi.getXRPCoinStat();
