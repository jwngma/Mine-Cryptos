...
public class MoneroFragment extends Fragment {
    ...
    LineChart lineChart;
    BarChart barChart;
    String uurl="https://min-api.cryptocompare.com/data/top/exchanges/full?fsym=XMR&tsym=USD";
    ...
    public void DisplayGraph(String totalCoin, String totalCoinMined) {
        ...
        yValue.add(new PieEntry(Float.parseFloat(total_mined), "Total Coin Mined"));
        yValue.add(new PieEntry(Float.parseFloat("99993093880" ), "Total Coin"));
    ...
    private void initMoneroData() {
        ...
        Call<CoinStatModel> call = retrofitApi.getMNRCoinStat();
        call.enqueue(new Callback<CoinStatModel>() {
            ...
            public void onResponse(Call<CoinStatModel> call, Response<CoinStatModel> response) {
                ...
                if (!response.isSuccessful()) {
                    ...
                    coinVolume.setText("Volume: "+"99,993,093,880 ");
