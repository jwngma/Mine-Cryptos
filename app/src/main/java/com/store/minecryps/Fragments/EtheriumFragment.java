 ...
 */
public class EtheriumFragment extends Fragment {
    ...
    String uurl="https://min-api.cryptocompare.com/data/top/exchanges/full?fsym=ETH&tsym=USD";

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View view= inflater.inflate(R.layout.fragment_etherium, container, false);
        initAll(view);
        initEtheriumData();
        return  view;
    }
    ...
    private void initEtheriumData() {
        ...
        Call<CoinStatModel> call = retrofitApi.getEthCoinStat();
