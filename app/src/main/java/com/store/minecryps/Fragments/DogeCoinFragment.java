...
public class DogeCoinFragment extends Fragment {
    ...
    private String coinname, coinprice, coinhighprice, coinopen, coinlow, coinvolume, coinlasttradeid, coinlastupdate,totalMined;
    PieChart pieChart;
    LineChart lineChart;
    BarChart barChart;

    String uurl="https://min-api.cryptocompare.com/data/top/exchanges/full?fsym=DOGE&tsym=USD";
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View view= inflater.inflate(R.layout.fragment_doge_coin, container, false);
        initAll(view);
        initDoge();
        return  view;
    }
    ...
    private void initDoge() {
        ...
        Call<CoinStatModel> call = retrofitApi.getDOGECoinStat();
        call.enqueue(new Callback<CoinStatModel>() {
            ...
            public void onResponse(Call<CoinStatModel> call, Response<CoinStatModel> response) {
                ...
                if (!response.isSuccessful()) {
                    ...
                    coinvolume=response.body().getData().getAggregatedData().getmKTCAP();
                    ...
                    totalMined=response.body().getData().getCoinInfo().getTotalCoinsMined();
                    ...
                    coinVolume.setText("Volume: "+"119,248,175,122");
    ...
    public void DisplayGraph(String totalCoin, String totalCoinMined) {
        ...
        yValue.add(new PieEntry(Float.parseFloat("119248175122"), "Total Coin"));
        yValue.add(new PieEntry(Float.parseFloat(totalMined),"Total Coin Mined" ));
